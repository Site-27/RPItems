...
public class Knife : CustomItem
{
    ...
    // NOTE: swap back to the guard clause (previous iteration) if this method grows any further. Given the circumstances, I do not believe it will grow any further.
